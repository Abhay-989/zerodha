  ...
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5 ">
        ...
        <p>
            &copy; 2010-2024, Not Zerodha Broking Lyd. All rights reserved.
        </p>
        </div>
        <div className="col">
          <p>Company</p>
          ...
          <br />
          <a href="" className="  text-muted" style={{textDecoration:"none"}}>cares</a>
          <br />
        </div>
        <div className="col">
          <p>Support</p>
        ...
        <div className="col">
          <p>Account</p>
          <a href="" className="  text-muted" style={{textDecoration:"none"}}>Open an accountFund </a>
          <br />
          <a href="" className="  text-muted" style={{textDecoration:"none"}}>transfer</a>
          <br />
          <a href="" className="  text-muted" style={{textDecoration:"none"}}>60day challenge</a>
          <br />
        </div>
      </div>
